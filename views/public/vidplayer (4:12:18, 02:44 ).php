		         ...
		         readyCallback: function( playerId ){
					...
					var end = finalendTime<?php echo $id_suffix;?>;
						...
						kdp.kBind( 'playerUpdatePlayhead', function(event){
								...
								$("#currentTime<?php echo $id_suffix;?>(event<?php echo $id_suffix;?>)").html("<b>"+getFormattedTimeString(JSON.stringify(event))+"</b> - "+getFormattedTimeString(end));
							  var ctime = "0:00:00";
							  var scenes;
							  var sel;
							  var i = 0;
						...
						<div class="displaySegmentRightColumn" style="float:<?php echo $float;?>;" >
							...
							<ul id="eventList" style="-webkit-padding-start:10px;">	    								<li id="<?php echo metadata('item', array('Dublin Core', 'Identifier'));?>" class="liBullet <?php echo metadata('item',array('Streaming Video','Segment Type'));?>">
									...
									<div class="eventLabel"><?php echo metadata('item',array('Streaming Video','Segment Type'));?></br>
										...
										<p id="currentTime<?php echo $id_suffix;?>" class="timecode<?php echo $id_suffix;?>" style="margin: 0 0 0 0;"><?php echo $this->getFormattedTimeString(metadata('item',array('Streaming Video','Segment Start')));?> - <?php echo $this->getFormattedTimeString(metadata('item',array('Streaming Video','Segment End')));?></p>
										...
										<p style="margin: 0 0 0 0;" class="timecode<?php echo $id_suffix;?>"></p>
									</div>
							        
							        <a class="header<?php echo $id_suffix;?>" id="header<?php echo $id_suffix;?>" title="Show Description" href='#'>Show Description</a>									
									<div class="play<?php echo $id_suffix;?>" title="Video Segment Description" id="hiearchy_<?php echo metadata('item', array('Dublin Core', 'Identifier'));?>" style="display:none; margin-top: 10px; border-top:1px dotted #333; border-bottom:1px dotted #333; padding: 5%; width: 90%;">
...
<script>
	 $("#header<?php echo $id_suffix;?>").click(function (event) {								
        ...
        $("#doplay<?php echo $id_suffix;?>").click(function (event) {
			event.preventDefault();
