...
<?php
	...
	<?php if ($current) { ?>
		...
		<?php $width=100;?>
	<?php }; ?>
	<?php if (metadata('item', array('Streaming Video','Segment Type')) == 'kaltura'){?>
		...
		<script src="https://cdnapisec.kaltura.com/p/<?php echo metadata('item',array('Streaming Video','Video File ID'));?>/sp/<?php echo metadata('item',array('Streaming Video','Video File ID'));?>00/embedIframeJs/uiconf_id/<?php echo metadata('item',array('Streaming Video','Partner ID'));?>/partner_id/<?php echo metadata('item',array('Streaming Video','Video File ID'));?>"></script>
			<script>
				      kWidget.embed({
		...
		<?php if (metadata('item', array('Streaming Video','Video Source')) == 'youtube'){?>
			...
			<video id="video<?php echo $eid_suffix;?>" Title="Video Player <?php echo $eid_suffix;?>"class="video-js vjs-default-skin" style="float:<?php echo $float?>;"
				...
				<?php } else { ?>
					...
					<?php if (metadata('item',array('Streaming Video','Video File ID'))){?>
						<source src="<?php echo metadata('item',array('Streaming Video','Video File ID'));?><?php echo metadata('item',array('Streaming Video','Partner ID'));?><?php echo metadata('item',array('Streaming Video','Video UI Conf'));?>" type='rtmp/mp4'/>
					<?php } ?>
		...
		<?php }; ?>
			<?php if ($current) { ?>
					...
					$orig_video = metadata("item", array("Streaming Video","Video UI Conf"));?>
					<?php ?>
